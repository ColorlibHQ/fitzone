(function( $ , api){
    ...
    api.section( 'fitzone_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'fitzone_about_section' , function( section ){
    ...
    api.section( 'fitzone_blog_section' , function( section ){
    ...
    api.section( 'fitzone_portfolio_section' , function( section ){
    ...
    api.section( 'fitzone_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-fitzone_contact_custom_formshortcode'),
                selector = $('#_customize-input-fitzone_contact_formshortcode');
    ...
    // General section
    api.section( 'fitzone_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#fitzone_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-fitzone_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-fitzone_preloader_color' );
            ...
            var $backtotop          = $( '#fitzone_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-fitzone_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-fitzone_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'fitzone_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#fitzone_footer_widget_toggle');
