...
----------------------------------------*/
class fitzone_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('fitzone_instagram_photo',esc_html__('[ Fitzone ] Intagram Photo','fitzone'),array(
			'description' => esc_html__('Fitzone Instagram Photo Widget','fitzone'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'fitzone');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'fitzone'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'fitzone'); ?></label>
...
if(!function_exists('fitzone_instagram_widgets')):
	function fitzone_instagram_widgets(){
		register_widget('fitzone_instagram_photo');
	}
	add_action('widgets_init','fitzone_instagram_widgets');
endif;
