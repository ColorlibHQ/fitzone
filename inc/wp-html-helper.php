...
// image default alt
if( !function_exists( 'fitzone_img_default_alt' ) ){
	function fitzone_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'fitzone_img_tag' ) ){
	function fitzone_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = fitzone_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'fitzone_anchor_tag' ) ){
	function fitzone_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'fitzone_heading_tag' ) ){
	function fitzone_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'fitzone_paragraph_tag' ) ){
	function fitzone_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'fitzone_other_tag' ) ){
	function fitzone_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'fitzone_button_element ' ) ){
	function fitzone_button_element( array $args ){
